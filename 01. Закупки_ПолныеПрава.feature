...
Сценарий: 01.01. Виды цен

	* Открываем справочник
		
		Дано Я открываю основную форму списка справочника "ВидыЦен"
		Тогда открылось окно 'Параметры прайс-листа'
		Когда открылось окно 'Параметры прайс-листа'
		...
		И я жду закрытия окна 'Параметры прайс-листа *' в течение 20 секунд

Сценарий: 01.02. Корпоративные закупки (настройки)
...
Сценарий: 01.03. Приказ о назначении закупочной комиссии
...
Сценарий: 01.04. Источники финансирования
...
Сценарий: 01.05. Установка цен номенклатуры
...
Сценарий: 01.06. Расширяем профиль группы доступа для МенеджерПоЗакупкам1
