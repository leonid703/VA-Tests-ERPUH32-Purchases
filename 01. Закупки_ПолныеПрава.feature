...
Сценарий: 01.01. Корпоративные закупки (настройки)
	...
	* Вид плана
		...
		И из выпадающего списка с именем "Владелец" я выбираю точное значение 'Корпоративные закупки (RUB), Месяц'
	...
	* Сквозное планирование потребности - выключено
		...
		И я устанавливаю флаг с именем 'СквозноеПланированиеПотребности'
