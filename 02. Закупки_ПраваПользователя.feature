...
Контекст:
	...
	И я подключаю TestClient "ЕРПУХ - Закупки1" логин "МенеджерПоЗакупкам1" пароль ""
...
Сценарий: 02.06. [ЗАПРОС ПРЕДЛОЖЕНИЙ]Закупочная процедура 2 / попозиционная
	...
	* Создаем процедуру
		...
		Тогда открылось окно 'Строки планов закупок'
		И в таблице "Список" я перехожу к строке:
			| 'Валюта документа' | 'Заказчик'                 | 'Организатор закупок' |'Период закупок' | 'Предмет договора'                | 'Состояние' | 'Способ закупки'     | 'Статус'    | 'Сумма документа' |
...
Сценарий: 02.15. [Обеспечение потребностей] Королевство Севера
...
Сценарий: 02.16. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] Заявка на обеспечение
...
Сценарий: 02.17. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] Договор
...
Сценарий: 02.18. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] Заказ поставщику
...
Сценарий: 02.19. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] ПТУ
...
Сценарий: 02.20. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] Возврат поставщику
...
Сценарий: 02.21. [ЗАЯВКА -> СПЗ; Королевство Дорна] Заявка на обеспечение 
...
Сценарий: 02.22. [ЗАЯВКА -> СПЗ; Королевство Дорна] СПЗ
...
Сценарий: 02.23. [ЗАЯВКА -> ЛОТ;  Королевство простора] Заявка на обеспечение
...
Сценарий: 02.24. [ЗАЯВКА -> ЛОТ;  Королевство простора] Закупочная процедура 
...
Сценарий: 02.25. [ЗАЯВКА -> ДОГОВОР] Заявка на обеспечение Королевство Гор и Долин
...
Сценарий: 02.26. [ЗАЯВКА -> ДОГОВОР] Договор ДД5 Королевство Гор и Долин
